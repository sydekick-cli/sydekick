...
import { IChatMessage } from "../../../../provider/chatCompletion/model/IChatMessage.js";
  ...
  implements IAiChatCompletionProvider
{
  ...
  public async executeChatSession(chatMessages: IChatMessage[]): Promise<IChatMessage[]> {
    const debug = debugLog("@sydekick/lib-core:OpenAiChatCompletionProvider::executeChatSession");
